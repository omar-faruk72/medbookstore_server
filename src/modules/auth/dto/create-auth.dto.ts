...
export class CreateAuthDto {
  ...
  @IsString({ message: 'পাসওয়ার্ড অবশ্যই স্ট্রিং হতে হবে' })
  password!: string;

  @IsOptional() // 👈 ইউজার না দিলেও কোনো সমস্যা নেই
  @IsString({ message: 'ইমেজ ইউআরএল স্ট্রিং হতে হবে' })
  imageUrl?: string;

  @IsOptional() // 👈 অ্যাড্রেসও এখন অপশনাল
